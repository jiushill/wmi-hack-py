...
Set objFileToRead = CreateObject("Scripting.FileSystemObject").OpenTextFile("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA",1)
...
asec.name="BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB"
